...
import com.deemedconveyance.deemconveyanceversionone.Activity.ShowResourceContent;
...
public class ResourceAdapter extends RecyclerView.Adapter<ResourceAdapter.MyViewHolder> {
    ...
    public ResourceAdapter(Context mContext, List<Titile> mData)
    {
...
//        Toast.makeText(mContext, (CharSequence) parent,Toast.LENGTH_SHORT).show();
        vHolder.item_list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Intent intent = new Intent(mContext, ShowResourceContent.class);
