...
public class RequestForProposalForm extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_request_for_proposal_form);

        builder = new AlertDialog.Builder(RequestForProposalForm.this);
        progressDialog = new ProgressDialog(RequestForProposalForm.this);
    ...
    public void onClick(View v)
    {
        ...
        {
            StringRequest stringRequest = new StringRequest(Request.Method.POST,URL_Request_Proposal,
                    new Response.Listener<String>()
                    {
                        ...
                        public void onResponse(String response)
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    progressDialog.dismiss();
                                    Toast.makeText(RequestForProposalForm.this,"error in josnobject format",Toast.LENGTH_LONG).show();
                                }
                    ...
                    })
            {
                ...
                MySingleton.getInstance(RequestForProposalForm.this).addToRequestQueue(stringRequest);
        ...
        if(input_error =="successfull")
        {
            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener()
            {
                ...
                public void onClick(DialogInterface dialogInterface, int i)
                {
                    ...
                    Intent intent = new Intent(RequestForProposalForm.this,MainActivity.class);
