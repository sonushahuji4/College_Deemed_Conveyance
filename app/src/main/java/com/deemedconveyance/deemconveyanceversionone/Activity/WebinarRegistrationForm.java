...
import static com.deemedconveyance.deemconveyanceversionone.Constant.Constants.URL_Request_Proposal;
import static com.deemedconveyance.deemconveyanceversionone.Constant.Constants.URL_Request_Registeration;

public class WebinarRegistrationForm extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_webinar_registration_form);


        builder = new AlertDialog.Builder(WebinarRegistrationForm.this);
        progressDialog = new ProgressDialog(WebinarRegistrationForm.this);
    ...
    public void onClick(View v)
    {
        ...
        {
            StringRequest stringRequest = new StringRequest(Request.Method.POST,URL_Request_Registeration,
                    new Response.Listener<String>()
                    {
                        ...
                        public void onResponse(String response)
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    progressDialog.dismiss();
                                    Toast.makeText(WebinarRegistrationForm.this,"error in josnobject format",Toast.LENGTH_LONG).show();
                                }
            ...
            MySingleton.getInstance(WebinarRegistrationForm.this).addToRequestQueue(stringRequest);
        ...
        if(input_error =="successfull")
        {
            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener()
            {
                ...
                public void onClick(DialogInterface dialogInterface, int i)
                {
                    ...
                    Intent intent = new Intent(WebinarRegistrationForm.this,MainActivity.class);
